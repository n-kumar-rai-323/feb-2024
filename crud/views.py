...
def add_student(request):
    if request.method == "POST":
        ...
        student = Student.objects.create(name=name, age=age, department=department, profile_picture=pp, classroom=class_obj)
        StudentProfile.objects.create(email=email, phone_number=phone, address=address, student=student)
...
def student_delete(request,id):
    ...
    return render(request, "crud/delete_student.html", context=context)
@login_required
